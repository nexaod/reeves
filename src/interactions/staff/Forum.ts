...
export default class Forum extends BotInteraction {
    ...
    private async convertForumPost(interaction: ChatInputCommandInteraction) {
        ...
        // force the new cache to store archived threads too
        ...
        // const _cache_threads = this.client.guilds.cache
        //     .get('918662128632733696')
        //     .channels.cache.get('1021892943218483230')
        //     .threads.cache.map((post) => new Object({ name: post.name, id: post.id, isBotUser: post.ownerId !== '1015008038823931994' }));
        // interaction.editReply(_forum?.name);
    }
